...
public class SecurityConfig {
    ...
    public AuthenticationProvider authProvider() {
        ...
        provider.setPasswordEncoder(NoOpPasswordEncoder.getInstance()); // No password encryption
        return provider;
    }
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> auth.anyRequest().authenticated());  // All requests need authentication
